...
trainingX = open(r"Working scripts\Player movement prediction\Training data\Training_ready_data.TF_MX_DATA", "w")
trainingY = open(r"Working scripts\Player movement prediction\Training data\Training_ready_data.TF_MY_DATA", "w")
...
testingX = open(r"Working scripts\Player movement prediction\Training data\Testing_ready_data.TF_MX_DATA", "w")
testingY = open(r"Working scripts\Player movement prediction\Training data\Testing_ready_data.TF_MY_DATA", "w")
